<nav class="col-sm-12 d-flex flex-column flex-sm-row justify-content-between border-top cv__social-bar">
    <div class="cv__links">
        <a href="#" class="cv__link"> Reageer nu ›</a>
        <a href="#" class="cv__link">Reageer met LinkedIn ›</a>
    </div>
